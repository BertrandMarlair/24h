...
import {anim} from "./core/anim2";
import {dot} from "./core/dot2";
...
const Svg = ({velo}) => {
    ...
    return (
        ...
        >
            ...
            <path id={`dot-${velo}`} style={{fill: velo === "velo1" ? "#231F20" : "#FF0000"}} transform-origin="0 0" d="M56.48,29.333c-0.429,0-0.853,0.023-1.271,0.064l-3.316-13.81c-0.162-0.674-0.766-1.149-1.459-1.149
